# This file contains an Xosd with a movable slider and title.
...
module XOSD
  ...
  # This class is an Xosd with a nice slider.
  class XosdSlider < Xosd
    # The title of this slider.
    attr_accessor :title
    # The value of this slider, from 1 to 100.
    attr_accessor :value
    ...
    def show
      if title_on_top then
        ...
        if value then
          display_slider(1, value)
        end
      else
        if value then
          display_slider(0, value)
        end
        if title then
